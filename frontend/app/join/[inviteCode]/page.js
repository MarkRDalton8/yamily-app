        ...
        {isLoggedIn ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder:text-gray-500 text-gray-900"
              />
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2 placeholder:text-gray-500 text-gray-900">Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2 placeholder:text-gray-500 text-gray-900">Password</label>
                <input
                  type="password"
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2 placeholder:text-gray-500 text-gray-900">
                  Party Pseudonym 🎭
                </label>
                <input
                  type="text"
                ...
                />
                <p className="text-sm text-gray-700 mt-1 placeholder:text-gray-500 text-gray-900">
