        ...
        <div className="mt-8 pt-8 border-t border-gray-300 max-w-xl mx-auto">
          ...
          <form onSubmit={handleCodeSubmit} className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-lg text-center sm:text-left text-gray-900 placeholder:text-gray-500 text-gray-900"
              maxLength={8}
            />
            <button
              type="submit"
